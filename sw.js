...
const CORE_ASSETS = [
  './',
  './index.html',
  './style.css?v=20260328-sync-fix-1',
  './app/app.js?v=20260328-sync-fix-1',
  './app/db.js?v=20260328-sync-fix-1',
  './app/sync.js?v=20260328-sync-fix-1',
  './app/storage-scope.js?v=20260328-sync-fix-1',
  './app/manifest.json?v=20260328-sync-fix-1',
  './app/bgm.js?v=20260328-sync-fix-1',
  './assets/bgm/pinknoise.m4a',
  './app/icon.svg?v=2',
  './sw.js?v=20260328-sync-fix-1'
];
